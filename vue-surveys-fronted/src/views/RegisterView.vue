...
<div class="flex min-h-full flex-col justify-center px-6 py-10 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <img class="mx-auto h-20 w-auto" src="https://images-platform.99static.com//FZl7mxT3QfUyDLbpk_I4OfGuQfs=/240x289:1750x1799/fit-in/500x500/99designs-contests-attachments/97/97093/attachment_97093827" alt="Your Company">
    <h2 class="mt-4 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Register</h2>
  </div>
